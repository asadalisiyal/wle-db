...
test-rocksdb:
	CGO_CFLAGS="-I/usr/local/include" CGO_LDFLAGS="-L/usr/local/lib -lrocksdb -lz -lbz2 -lsnappy -llz4 -lzstd -ljemalloc" go test -v -mod=readonly -tags=rocksdbBackend ./... -covermode=atomic -coverprofile=./profile.out
